var je={getAllDepartments:"https://employee-managers.herokuapp.com/api/departments/",updateEmployee:"https://employee-managers.herokuapp.com/api/departments/employee/update",getDepartment:a=>`https://employee-managers.herokuapp.com/api/departments/name/${a}`,deleteEmployee:a=>`https://employee-managers.herokuapp.com/api/departments/employee/id/${a}`},L=je;var Le=async a=>await(await fetch(a)).json(),Se=async a=>await(await fetch(a,{method:"DELETE",redirect:"follow"})).json(),Ce=async(a,n)=>{let s=new Headers;s.append("Content-Type","application/json");let o=JSON.stringify(n),m=await(await fetch(a,{method:"PUT",headers:s,body:o,redirect:"follow"})).text()},Ae={getRequest:Le,deleteRequest:Se,putRequest:Ce},S=Ae;var De=function(){let a=null;function n(){let s=document.createElement("img");document.body.appendChild(s);let o=async m=>{let u=await S.deleteRequest(L.deleteEmployee(m.detail.id));console.log(u),s.dispatchEvent(new CustomEvent("removeItem",{bubbles:!0,detail:u}))},c=async m=>{let u=await S.putRequest(L.updateEmployee,m.detail.payload)},h=async m=>{let u=await S.getRequest(L.getDepartment(m.detail.name));s.dispatchEvent(new CustomEvent("updateDisplay",{bubbles:!0,detail:u}))};return s.addEventListener("deleteEmployee",o),s.addEventListener("editEmployee",c),s.addEventListener("sideBarSelect",h),{handle:s}}return{getInstance:function(){return a||(a=n()),a}}}(),A=De;var G=`
    <ul class="departments"></ul>
`,Z=`
   <li class="department" data-name="<%-data.name%> "><%-data.name%></li>
`;function Oe(a){return document.createRange().createContextualFragment(a).firstElementChild}var T=Oe;var xe=function(){return T(G)},K=xe;function Q(a,n,s){return s={path:n,exports:{},require:function(o,c){return Fe(o,c??s.path)}},a(s,s.exports),s.exports}function Fe(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var P={};function Y(a,n){for(var s=0,o=a.length-1;o>=0;o--){var c=a[o];c==="."?a.splice(o,1):c===".."?(a.splice(o,1),s++):s&&(a.splice(o,1),s--)}if(n)for(;s--;s)a.unshift("..");return a}var Ie=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/,k=function(a){return Ie.exec(a).slice(1)};function M(){for(var a="",n=!1,s=arguments.length-1;s>=-1&&!n;s--){var o=s>=0?arguments[s]:"/";if(typeof o!="string")throw new TypeError("Arguments to path.resolve must be strings");if(!o)continue;a=o+"/"+a,n=o.charAt(0)==="/"}return a=Y(q(a.split("/"),function(c){return!!c}),!n).join("/"),(n?"/":"")+a||"."}function B(a){var n=N(a),s=Me(a,-1)==="/";return a=Y(q(a.split("/"),function(o){return!!o}),!n).join("/"),!a&&!n&&(a="."),a&&s&&(a+="/"),(n?"/":"")+a}function N(a){return a.charAt(0)==="/"}function ee(){var a=Array.prototype.slice.call(arguments,0);return B(q(a,function(n,s){if(typeof n!="string")throw new TypeError("Arguments to path.join must be strings");return n}).join("/"))}function te(a,n){a=M(a).substr(1),n=M(n).substr(1);function s(g){for(var _=0;_<g.length&&g[_]==="";_++);for(var w=g.length-1;w>=0&&g[w]==="";w--);return _>w?[]:g.slice(_,w-_+1)}for(var o=s(a.split("/")),c=s(n.split("/")),h=Math.min(o.length,c.length),m=h,u=0;u<h;u++)if(o[u]!==c[u]){m=u;break}for(var p=[],u=m;u<o.length;u++)p.push("..");return p=p.concat(c.slice(m)),p.join("/")}var ne="/",ae=":";function re(a){var n=k(a),s=n[0],o=n[1];return!s&&!o?".":(o&&(o=o.substr(0,o.length-1)),s+o)}function ie(a,n){var s=k(a)[2];return n&&s.substr(-1*n.length)===n&&(s=s.substr(0,s.length-n.length)),s}function se(a){return k(a)[3]}var Re={extname:se,basename:ie,dirname:re,sep:ne,delimiter:ae,relative:te,join:ee,isAbsolute:N,normalize:B,resolve:M};function q(a,n){if(a.filter)return a.filter(n);for(var s=[],o=0;o<a.length;o++)n(a[o],o,a)&&s.push(a[o]);return s}var Me="ab".substr(-1)==="b"?function(a,n,s){return a.substr(n,s)}:function(a,n,s){return n<0&&(n=a.length+n),a.substr(n,s)},Pe=Object.freeze({__proto__:null,resolve:M,normalize:B,isAbsolute:N,join:ee,relative:te,sep:ne,delimiter:ae,dirname:re,basename:ie,extname:se,default:Re}),E=Q(function(a,n){var s=/[|\\{}()[\]^$+*?.]/g;n.escapeRegExpChars=function(u){return u?String(u).replace(s,"\\$&"):""};var o={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&#34;","'":"&#39;"},c=/[&<>'"]/g;function h(u){return o[u]||u}var m=`var _ENCODE_HTML_RULES = {
      "&": "&amp;"
    , "<": "&lt;"
    , ">": "&gt;"
    , '"': "&#34;"
...
`+m},n.shallowCopy=function(u,p){p=p||{};for(var g in p)u[g]=p[g];return u},n.shallowCopyFromList=function(u,p,g){for(var _=0;_<g.length;_++){var w=g[_];typeof p[w]!="undefined"&&(u[w]=p[w])}return u},n.cache={_data:{},set:function(u,p){this._data[u]=p},get:function(u){return this._data[u]},remove:function(u){delete this._data[u]},reset:function(){this._data={}}},n.hyphenToCamel=function(u){return u.replace(/-[a-z]/g,function(p){return p[1].toUpperCase()})}}),ke="ejs",qe="Embedded JavaScript templates",Ne=["template","engine","ejs"],Be="3.1.6",He="Matthew Eernisse <mde@fleegix.org> (http://fleegix.org)",We="Apache-2.0",$e={ejs:"./bin/cli.js"},Ue="./lib/ejs.js",Ve="ejs.min.js",ze="ejs.min.js",Je={type:"git",url:"git://github.com/mde/ejs.git"},Xe="https://github.com/mde/ejs/issues",Ge="https://github.com/mde/ejs",Ze={jake:"^10.6.1"},Ke={browserify:"^16.5.1",eslint:"^6.8.0","git-directory-deploy":"^1.5.1",jsdoc:"^3.6.4","lru-cache":"^4.0.1",mocha:"^7.1.1","uglify-js":"^3.3.16"},Qe={node:">=0.10.0"},Ye={test:"mocha"},et={name:ke,description:qe,keywords:Ne,version:Be,author:He,license:We,bin:$e,main:Ue,jsdelivr:Ve,unpkg:ze,repository:Je,bugs:Xe,homepage:Ge,dependencies:Ze,devDependencies:Ke,engines:Qe,scripts:Ye},tt=Q(function(a,n){var s=Pe,o=!1,c=et.version,h="<",m=">",u="%",p="locals",g="ejs",_="(<%%|%%>|<%=|<%-|<%_|<%#|<%|%>|-%>|_%>)",w=["delimiter","scope","context","debug","compileDebug","client","_with","rmWhitespace","strict","filename","async"],ge=w.concat("cache"),W=/^\uFEFF/;n.cache=E.cache,n.fileLoader=P.readFileSync,n.localsName=p,n.promiseImpl=new Function("return this;")().Promise,n.resolveInclude=function(t,r,e){var i=s.dirname,l=s.extname,d=s.resolve,v=d(e?r:i(r),t),j=l(t);return j||(v+=".ejs"),v};function $(t,r){var e;if(r.some(function(i){return e=n.resolveInclude(t,i,!0),P.existsSync(e)}))return e}function ye(t,r){var e,i,l=r.views,d=/^[A-Za-z]+:\\|^\//.exec(t);if(d&&d.length)t=t.replace(/^\/*/,""),Array.isArray(r.root)?e=$(t,r.root):e=n.resolveInclude(t,r.root||"/",!0);else if(r.filename&&(i=n.resolveInclude(t,r.filename),P.existsSync(i)&&(e=i)),!e&&Array.isArray(l)&&(e=$(t,l)),!e&&typeof r.includer!="function")throw new Error('Could not find the include file "'+r.escapeFunction(t)+'"');return e}function O(t,r){var e,i=t.filename,l=arguments.length>1;if(t.cache){if(!i)throw new Error("cache option requires a filename");if(e=n.cache.get(i),e)return e;l||(r=U(i).toString().replace(W,""))}else if(!l){if(!i)throw new Error("Internal EJS error: no file name or template provided");r=U(i).toString().replace(W,"")}return e=n.compile(r,t),t.cache&&n.cache.set(i,e),e}function Ee(t,r,e){var i;if(e){try{i=O(t)(r)}catch(l){return e(l)}e(null,i)}else{if(typeof n.promiseImpl=="function")return new n.promiseImpl(function(l,d){try{i=O(t)(r),l(i)}catch(v){d(v)}});throw new Error("Please provide a callback function")}}function U(t){return n.fileLoader(t)}function _e(t,r){var e=E.shallowCopy({},r);if(e.filename=ye(t,e),typeof r.includer=="function"){var i=r.includer(t,e.filename);if(i&&(i.filename&&(e.filename=i.filename),i.template))return O(e,i.template)}return O(e)}function V(t,r,e,i,l){var d=r.split(`
...
`,y.message+="Or, if you meant to create an async function, pass `async: true` as an option.")),y}var I=e.client?r:function(J){var be=function(Te,X){var R=E.shallowCopy({},J);return X&&(R=E.shallowCopy(R,X)),_e(Te,e)(R)};return r.apply(e.context,[J||{},d,be,V])};if(e.filename&&typeof Object.defineProperty=="function"){var x=e.filename,we=s.basename(x,s.extname(x));try{Object.defineProperty(I,"name",{value:we,writable:!1,enumerable:!1,configurable:!0})}catch(y){}}return I},generateSource:function(){var t=this.opts;t.rmWhitespace&&(this.templateText=this.templateText.replace(/[\r\n]+/g,`
...
`)}},n.escapeXML=E.escapeXML,n.__express=n.renderFile,n.VERSION=c,n.name=g,typeof window!="undefined"&&(window.ejs=n)}),oe=tt;function nt(a,n){return oe.render(a,{data:n})}var D=nt;var at=A.getInstance(),le=new CustomEvent("sideBarSelect",{bubbles:!0,detail:{name:null}}),it=function(a){let n=D(Z,a),s=T(n);return s.addEventListener("click",rt),s},rt=a=>{le.detail.name=a.currentTarget.dataset.name,at.handle.dispatchEvent(le)},ce=it;var st=document.querySelector("#sidebar"),ot=function(){return{init:function(n){let s=K();n.forEach(o=>{let c=ce(o);s.append(c)}),st.append(s)}}},ue=ot;var lt=`
...
`,ut={parentTemplate:ct,childTemplate:lt},H=ut;var mt=a=>{let n=document.querySelector("#managers"),s=a.filter(c=>c.role),o=T(H.parentTemplate);return s.forEach(c=>{let h=D(H.childTemplate,c),m=T(h);o.appendChild(m)}),o},me=mt;var de=`
...
`;var fe=A.getInstance(),dt=function(a){let n=T(de),s=a.filter(c=>!c.role),o=c=>{switch(c.target.id){case"delete":fe.handle.dispatchEvent(new CustomEvent("deleteEmployee",{bubbles:!0,detail:{id:c.currentTarget.dataset.id}})),n.removeChild(c.currentTarget.parentElement);break;case"edit":let h={id:c.currentTarget.dataset.id,firstname:c.currentTarget.parentElement.querySelector("#firstname").value.trim(),lastname:c.currentTarget.parentElement.querySelector("#lastname").value.trim(),salary:c.currentTarget.parentElement.querySelector("#salary").value.trim(),vacation:c.currentTarget.parentElement.querySelector("#vacation").value.trim()};fe.handle.dispatchEvent(new CustomEvent("editEmployee",{bubbles:!0,detail:{payload:h}}));break}};return s.forEach(c=>{let h=D(pe,c),m=T(h);m.querySelector(".controls").addEventListener("click",o),n.appendChild(m)}),n},he=dt;var pt=()=>{let a=document.querySelector("#panel"),n=document.querySelector("#widget-heading"),s=null,o=null,c=m=>{n.textContent=`${m[0].department} department`,s=a.appendChild(me(m)),o=a.appendChild(he(m))};return{updateDisplay:m=>{a.removeChild(s),a.removeChild(o),c(m)},view:a,init:c}},ve=pt;var ft=ve(),sn=ue(),ht=A.getInstance();ht.handle.addEventListener("updateDisplay",a=>{ft.updateDisplay(a.detail)});var vt=async function(){let a=await S.getRequest(L.getAllDepartments),n=await S.getRequest(L.getDepartment("training"));console.log(a)};vt();
/**
